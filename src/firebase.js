...
// Keep query resume data between sessions and share it across tabs. This prevents
// short reconnects and page reloads from downloading the same large snapshots.
