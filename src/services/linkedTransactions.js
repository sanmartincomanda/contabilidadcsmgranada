...
const buildPayableMirrorPayload = (purchaseData, updateData, payableData = {}) => {
    ...
    return cleanForFirestore({
        ...
        fixedQuota: merged.fixedQuota === true,
        ivaTreatment: merged.ivaTreatment || '',
        fixedQuotaOriginalFinancials: merged.fixedQuotaOriginalFinancials || null,
        fixedQuotaAdjustedAt: merged.fixedQuotaAdjustedAt || null,
