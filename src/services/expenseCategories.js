...
const heuristicRules = [
    ...
    [/res|carne|costilla|lomo|posta|cecina/, ['Costos de venta / compras', 'Compra de carne res']],
    ...
    [/agua/, ['Gastos del Local', 'Agua potable']],
...
export const findExpenseCategoryOption = (value) => {
    ...
    return OPTION_BY_ID.get(String(value)) || OPTION_BY_LABEL.get(normalizeKey(value)) || null;
};
...
export const getExpenseCategoryFromRecord = (record = {}, fallbackId = DEFAULT_EXPENSE_CATEGORY_ID) => {
    ...
    const option = direct || mapLegacyExpenseCategory(rawCategory, record) || OPTION_BY_ID.get(fallbackId) || OPTION_BY_ID.get(DEFAULT_EXPENSE_CATEGORY_ID);
